...
var blocked_sidebar = require("sdk/ui/sidebar").Sidebar({
      id: 'oabutton-blocked-sidebar',
      title: 'Open Access Button',
      url: require("sdk/self").data.url("blocked_sidebar.html"),
			onReady: function(worker) {
				worker.port.on("submit_blocked", function(story) {
...
var sidebar = require("sdk/ui/sidebar").Sidebar({
      ...
      url: require("sdk/self").data.url("sidebar.html"),
			...
			onReady: function(worker) {
				worker.port.on("report_paywall", function() {
					blocked_sidebar.show();
				});
